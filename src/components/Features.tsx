...
const Features = () => {
  return (
    <section className="bg-[#26262B] py-12 sm:py-16 md:py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        {/* Section Header */}
        <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-8 sm:mb-12 md:mb-16">
        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          <div className="w-full">
            <img
              ...
              className="w-full h-auto rounded-xl sm:rounded-2xl md:rounded-3xl"
            />
          </div>
        ...
        <div className="flex justify-center mt-8 sm:mt-10 md:mt-12">
          <a href="#" className="flex items-center gap-2 text-white font-medium hover:underline text-sm sm:text-base">
            <span className="text-[24px] sm:text-[28px] md:text-[31px] font-bold">→</span>
